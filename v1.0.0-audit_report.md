...
graph LR
    %% Jaringan Utama
    WAN((INTERNET / WAN)) -->|DHCP / NAT| Kali[Kali Linux <br> Auditor Node <br> IP: 10.216.27.10]
    
    Kali -->|Interface: eth1| Net{HOST-ONLY NETWORK <br> Subnet: 10.216.27.0/24}
    
    Net --> MT[Gateway / MikroTik Router <br> IP: 10.216.27.1]
    Net --> UB[Ubuntu Target Server <br> TechSecure Portal <br> IP: 10.216.27.100]

    %% Pemetaan Port & Target Serangan
    UB --> P21[Port 21: FTP <br> vsftpd 3.0.5]
    UB --> P22[Port 22: SSH <br> OpenSSH 9.6p1]
    UB --> P80[Port 80: HTTP <br> Apache 2.4.58]

    %% Simulasi Eksploitasi (Attack Vectors)
    Kali -.->|Anonymous Login <br> User Flag| P21
    Kali -.->|Hydra Brute Force <br> Foothold| P22
    Kali -.->|SQLi & RCE <br> www-data Shell| P80
```
